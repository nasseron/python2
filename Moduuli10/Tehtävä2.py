...
class Talo:
    def __init__(self, alimmainen_kerros, ylimmainen_kerros, hissien_lukumäärä):
        ...
        print(f"Talo luotu: {hissien_lukumäärä} hissiä, alimat ja ylmmät kerrokset: {alimmainen_kerros, ylimmainen_kerros}")
    ...
    def palohälytys(self):
        ...
        for hissit in self.hissit:
            hissi.siirry_kerrokseen(self.alimmainen_kerros)
